stage_data = {
    ...
    '14-3': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (686, 491), 'wo': True, 'ec': True, 'desc': "2 right"},

            # 第二回合
            {'t': 'click', 'p': (866, 408), 'ec': True, 'desc': "1 right"},
            {'t': 'click', 'p': (677, 396), 'wo': True, "after": 5, 'desc': "2 upper right"},

            # 第三回合
            {'t': 'click', 'p': (842, 317), 'ec': True, 'desc': "1 upper right"},
            {'t': 'click', 'p': (412, 339), 'ec': True, 'wo': True, 'desc': "2 left"},
    ...
    '14-4': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (610, 381), 'ec': True, 'wo': True, 'desc': "2 upper right"},
            ...
            {'t': 'click', 'p': (493, 219), 'wo': True, 'desc': "1 upper left"},

            # 第三回合
            {'before': 3, 't': 'click', 'p': (412, 315), 'ec': True, 'desc': "1 left"},
            {'t': 'click', 'p': (763, 408), 'wo': True, 'ec': True, 'desc': "2 lower right"},
    ...
    '14-5': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (559, 283), 'ec': True, 'wo': True, 'desc': "2 upper right"},

            # 第二回合
            {'t': 'click', 'p': (540, 267), 'ec': True, 'desc': "1 left"},
            {'t': 'click', 'p': (630, 336), 'ec': True, 'wo': True, 'desc': "2 right"},
            ...
            {'t': 'click', 'p': (517, 494), 'wo': True, "after": 5, 'desc': "1 lower left"},
