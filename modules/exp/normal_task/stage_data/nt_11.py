stage_data = {
    '11-1': {
        ...
        'action': [
            ...
            {'t': 'move', 'wo': True, 'ec': True, 'desc': "teleport"},

            {'t': 'click', 'p': (556, 317), 'ec': True, 'desc': "1 upper right"},
            {'t': 'click', 'p': (684, 388), 'after': 5, 'wo': True, 'desc': "2 upper left"},
    ...
    '11-2': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (904, 412), 'wo': True, 'ec': True, 'desc': "2 right"},
    ...
    '11-3': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (672, 365), "ec": True, 'wo': True, 'desc': "2 left"},
    ...
    '11-4': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (558, 446), "ec": True, 'wo': True, 'desc': "2 lower right"},

            {'t': 'click', 'p': (634, 318), 'desc': "1 left"},
            {'t': 'move', 'ec': True, 'desc': "teleport"},
            {'t': 'click', 'p': (434, 422), 'ec': True, 'wo': True, 'desc': "2 left"},
    ...
    '11-5': {
        ...
        'action': [
            ...
            {'t': 'move', 'ec': True, 'desc': "teleport"},
            {'t': 'click', 'p': (613, 371), 'desc': "1 right", 'wo': True},

            {'t': 'click', 'p': (729, 377), "ec": True, 'desc': "1 right"},
            {'t': 'click', 'p': (616, 216), 'ec': True, 'wo': True, 'desc': "2 upper right"},

            {'t': 'click', 'p': (868, 437), 'ec': True, 'desc': "1 right"},
            {'t': 'click', 'p': (683, 290), 'wo': True, 'ec': True, 'desc': "2 right"},

            {'t': 'click', 'p': (715, 523), 'desc': "1 lower left"},
            {'t': 'move', 'ec': True, 'desc': "teleport"},
            {'t': 'click', 'p': (835, 288), 'ec': True, 'wo': True, 'desc': "2 right"},
