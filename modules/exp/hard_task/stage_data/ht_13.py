stage_data = {
    '13-1': {
        ...
        'action': [
            ...
            # 第四回合
            {'t': 'exchange', 'ec': True, "desc": "change to 2"},
            {'t': 'click', 'p': (885, 340), "wait-over": True, "desc": "2 right & get box"},
    ...
    '13-2': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (455, 365), "wait-over": True, "desc": "1 upper left & get box"},
    ...
    '13-3': {
        ...
        'action': [
            ...
            # 第四回合
            {'t': 'exchange', 'ec': True, "desc": "change to 2"},
            {'t': 'click', 'p': (840, 435), "wait-over": True, "desc": "2 lower right & get box"},
