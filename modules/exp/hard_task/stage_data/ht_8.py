stage_data = {
    '8-1': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (845, 475), 'ec': True, "wait-over": True, "desc": "1 lower right"},

            # 第三回合
            {'t': 'click', 'p': (555, 490), 'ec': True, "desc": "1 lower right"},
            {'t': 'click', 'p': (895, 425), "wait-over": True, "desc": "1 lower right"},
    ...
    '8-2': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (550, 475), 'ec': True, "wait-over": True, "desc": "2 lower right"},

            # 第二回合
            {'t': 'click', 'p': (665, 415), 'ec': True, "desc": "1 left"},
            {'t': 'click', 'p': (615, 440), 'ec': True, "wait-over": True, "desc": "2 right"},

            # 第三回合
            {'t': 'exchange', 'ec': True, "desc": "change to 2"},
            {'t': 'click', 'p': (555, 335), 'ec': True, "desc": "2 upper right"},
            {'t': 'click', 'p': (665, 405), "wait-over": True, "desc": "1 left"},

            # 第四回合
            {'t': 'click', 'p': (690, 550), "desc": "1 lower left"},
            {'t': 'move', "wait-over": True, "desc": "teleport"},
            {'t': 'click', 'p': (590, 235), 'ec': True, "wait-over": True, "desc": "2 upper right"},
            ...
            {'t': 'click', 'p': (435, 295), "wait-over": True, "desc": "2 left & get box"},
    ...
    '8-3': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (750, 415), "wait-over": True, "desc": "2 right"},

            # 第四回合
            {'t': 'click', 'p': (445, 265), 'ec': True, "desc": "1 left"},
            {'t': 'click', 'p': (890, 440), "wait-over": True, "desc": "2 right & get box"},
    ...
    '8-3-task': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (720, 340), "desc": "choose 2"},
            {'t': 'click', 'p': (615, 335), "desc": "change"},
            {'t': 'click', 'p': (600, 340), "wait-over": True, "desc": "1 left"},

            # 第二回合
            {'t': 'click', 'p': (465, 245), 'ec': True, "desc": "1 upper left"},
            {'t': 'click', 'p': (820, 370), "wait-over": True, "desc": "2 upper right"},

            # 第三回合
            {'t': 'exchange', 'ec': True, "desc": "change to 2"},
            {'t': 'click', 'p': (725, 310), 'ec': True, "desc": "2 upper right"},
            {'t': 'click', 'p': (520, 280), "wait-over": True, "desc": "2 upper left"},
