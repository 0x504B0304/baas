stage_data = {
    '15-1': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (555, 315), 'ec': True, 'wo': True, 'desc': "2 upper right"},

            # 第二回合
            {'t': 'click', 'p': (685, 230), 'ec': True, 'desc': "1 upper left"},
            {'t': 'click', 'p': (555, 340), 'ec': True, 'wo': True, 'desc': "2 upper right"},
            ...
            {'t': 'click', 'p': (510, 275), 'wo': True, 'desc': "1 upper left"},

            # 第四回合
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'click', 'p': (655, 410), 'wo': True, 'desc': "2 lower left & get box"},
    ...
    '15-2': {
        ...
        'action': [
            ...
            {'t': 'move', 'wo': True, 'desc': "teleport"},
            {'t': 'click', 'p': (700, 320), 'ec': True, 'wo': True, 'desc': "2 upper right"},

            # 第二回合
            {'t': 'click', 'p': (790, 475), 'desc': "1 lower right"},
            {'t': 'move', 'wo': True, 'desc': "teleport"},
            {'t': 'click', 'p': (630, 270), 'ec': True, 'wo': True, 'desc': "2 upper right"},
            ...
            {'t': 'click', 'p': (725, 195), 'wo': True, 'desc': "1 upper right"},

            # 第四回合
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'click', 'p': (765, 535), 'wo': True, 'desc': "2 lower right & get box"},
    ...
    '15-3': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (905, 375), 'wo': True, 'desc': "1 right"},
            ...
            {'t': 'move', 'wo': True, 'desc': "teleport"},
            {'t': 'click', 'p': (695, 595), 'wo': True, 'desc': "3 upper right"},
            ...
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'exchange', 'ec': True, 'desc': "change to 3"},
            {'t': 'click', 'p': (465, 550), 'wo': True, 'desc': "2 lower right & get box"},
