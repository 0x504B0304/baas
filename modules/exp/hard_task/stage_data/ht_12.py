stage_data = {
    '12-1': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (555, 505), "wait-over": True, "desc": "2 left & get box"},
    ...
    '12-2': {
        ...
        'action': [
            ...
            # 第四回合
            {'t': 'exchange', 'ec': True, "desc": "change to 2"},
            {'t': 'click', 'p': (640, 415), "wait-over": True, "desc": "2 upper left & get box"},
    ...
    '12-3': {
        ...
        'action': [
            ...
            # 第二回合
            {'t': 'click', 'p': (895, 400), "wait-over": True, "desc": "1 right & get box"},
