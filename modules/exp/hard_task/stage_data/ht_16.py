stage_data = {
    '16-1': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (725, 450), "wait-over": True, "desc": "1 upper left & get box"},
    ...
    '16-2': {
        ...
        'action': [
            ...
            # 第四回合
            {'t': 'exchange', 'ec': True, "desc": "change to 2"},
            {'t': 'click', 'p': (728, 468), "wait-over": True, "desc": "2 lower left & get box"},
    ...
    '16-3': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (835, 430), "wait-over": True, "desc": "3 lower right & get box"},
