stage_data = {
    '11-1': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (650, 420), 'ec': True, 'wo': True, 'desc': "2 left"},
            ...
            {'t': 'click', 'p': (515, 360), 'wo': True, 'desc': "1 upper left"},

            # 第四回合
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'click', 'p': (515, 200), 'wo': True, 'desc': "2 upper left & get box"},
    ...
    '11-2': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (655, 430), 'ec': True, 'wo': True, 'desc': "2 left"},

            # 第三回合
            {'t': 'click', 'p': (700, 285), 'ec': True, 'wo': True, 'desc': "1 right"},
            {'t': 'click', 'p': (700, 540), 'wo': True, 'desc': "2 lower left & get box"},

            # 第四回合
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'click', 'p': (720, 420), 'ec': True, 'wo': True, 'desc': "2 upper right"},
            {'t': 'end-turn', 'wo': True, },

            # 第五回合
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'click', 'p': (665, 405), 'ec': True, 'wo': True, 'desc': "2 upper left"},
            {'t': 'click', 'p': (635, 370), 'wo': True, 'desc': "1 lower right"},
    ...
    '11-2-task': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (700, 375), 'ec': True, 'wo': True, 'desc': "2 upper left"},

            # 第四回合
            {'t': 'click', 'p': (650, 415), 'ec': True, 'desc': "1 right"},
            {'t': 'click', 'p': (765, 410), 'ec': True, 'wo': True, 'desc': "2 upper left"},
    ...
    '11-3': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (630, 335), 'ec': True, 'wo': True, 'desc': "2 right"},

            # 第三回合
            {'t': 'click', 'p': (695, 550), 'wo': True, 'desc': "1 lower left & get box"},
