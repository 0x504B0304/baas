stage_data = {
    ...
    '10-1-box': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (463, 384), 'wo': True, 'desc': "2 lower left"},

            # 第二回合
            {'t': 'exchange', 'ec': True},
            {'t': 'click', 'p': (441, 475), 'ec': True, 'desc': "2 lower left"},
            {'t': 'click', 'p': (764, 398), 'wo': True, 'desc': "1 lower right"},

            # 第三回合
            {'t': 'click', 'p': (825, 476), 'wo': True, 'desc': "1 lower right & get box"},
            {'t': 'end-turn', 'wo': True},
    ...
    '10-2': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (640, 555), 'wo': True, 'desc': "1 lower right"},

            # 第二回合
            {'t': 'exchange', 'ec': True},
            {'t': 'click', 'p': (463, 425), 'ec': True, 'desc': "2 lower left"},
            {'t': 'click', 'p': (743, 424), 'wo': True, 'desc': "1 right"},

            # 第三回合
            {'t': 'exchange', 'ec': True},
            {'t': 'click', 'p': (469, 234), 'ec': True, 'desc': "2 upper left"},
            {'t': 'click', 'p': (773, 387), 'wo': True, 'desc': "1 right"},
            ...
            # 第五回合
            {'t': 'click', 'p': (897, 399), 'wo': True, 'desc': "1 right & get box"},
            {'t': 'end-turn', 'wo': True},
    ...
    '10-3': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (558, 317), 'wo': True, 'desc': "2 upper right"},
            ...
            {'t': 'click', 'p': (554, 306), 'wo': True, 'desc': "1 upper right"},

            # 第三回合
            {'t': 'click', 'p': (499, 224), 'ec': True, 'desc': "1 upper left"},
            {'t': 'click', 'p': (742, 505), 'wo': True, 'desc': "2 right"},

            # 第四回合
            {'t': 'exchange', 'ec': True},
            {'t': 'click', 'p': (750, 416), 'ec': True, 'desc': "2 upper right"},
            {'t': 'click', 'p': (567, 214), 'wo': True, 'desc': "1 upper left & get box"},
    ...
    '10-3-task': {
        ...
        'action': [
            ...
            {'t': 'exchange', 'ec': True},
            {'t': 'click', 'p': (750, 416), 'ec': True, 'desc': "2 upper right"},
            {'t': 'click', 'p': (506, 293), 'wo': True, 'desc': "1 left"},
