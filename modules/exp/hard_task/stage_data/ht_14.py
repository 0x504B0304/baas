stage_data = {
    '14-1': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (715, 500), 'ec': True, 'wo': True, 'desc': "2 right"},

            # 第二回合
            {'t': 'click', 'p': (780, 375), 'ec': True, 'desc': "1 lower right"},
            {'t': 'click', 'p': (715, 420), 'ec': True, 'wo': True, 'desc': "2 upper right"},

            # 第三回合
            {'t': 'click', 'p': (895, 340), 'ec': True, 'desc': "1 right"},
            {'t': 'click', 'p': (665, 365), 'ec': True, 'wo': True, 'desc': "2 upper right"},

            # 第四回合
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'click', 'p': (412, 322), 'ec': True, 'desc': "2 left"},
            {'t': 'click', 'p': (760, 405), 'wo': True, 'desc': "1 lower right"},

            # 第五回合
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'click', 'p': (450, 420), 'wo': True, 'desc': "2 lower left & get box"},
    ...
    '14-2': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (605, 395), 'ec': True, 'wo': True, 'desc': "2 upper right"},

            # 第二回合
            {'t': 'click', 'p': (640, 320), 'ec': True, 'desc': "1 left"},
            {'t': 'click', 'p': (643, 323), 'desc': "choose 1"},
            {'t': 'click', 'p': (540, 320), 'desc': "change"},
            {'t': 'click', 'p': (580, 235), 'wo': True, 'desc': "2 upper left"},

            # 第三回合
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'click', 'p': (520, 275), 'ec': True, 'desc': "2 left"},
            {'t': 'click', 'p': (565, 445), 'wo': True, 'desc': "1 left"},

            # 第四回合
            {'t': 'exchange', 'ec': True, 'desc': "change to 2"},
            {'t': 'click', 'p': (620, 200), 'wo': True, 'desc': "2 upper left & get box"},
    ...
    '14-3': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (460, 405), 'ec': True, 'wo': True, 'desc': "2 lower left"},

            # 第二回合
            {'t': 'click', 'p': (630, 465), 'ec': True, 'desc': "1 left"},
            {'t': 'click', 'p': (550, 465), 'ec': True, 'wo': True, 'desc': "2 lower right"},
            ...
            {'t': 'click', 'p': (565, 545), 'wo': True, 'desc': "1 lower left"},

            # 第四回合
            {'t': 'click', 'p': (390, 435), 'wo': True, 'desc': "1 left & get box"},
